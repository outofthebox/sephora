Sephora::Application.routes.draw do
  ...
  get   ':seccion', :to => 'secciones#ver', :constraints => { :seccion => /obsessionsbeautybloggers|hotnow|bestsellers|bbcreams|tintedmoisturizers|sephorabath|probrushes|beautyobsessions|vacaciones|ouidad|esteelaudernails|bronzers|clasicosdeskincare|/ }
